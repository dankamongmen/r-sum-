...
\item\textbf{Languages (amateur---minimum 1 serious project):} SPARC and M68k assembly, Java, ML, Scheme, JavaScript (and XUL), Scala, Clojure
\item\textbf{Technologies:} GCC, LLVM, Pthreads, OpenMP, CUDA, OpenCL, Berkeley sockets, ACE, Boost, Flex/Bison, ANTLR, \LaTeX, Apache, Postfix, MediaWiki, Bugzilla, VPNs, SSH, ERESI, GDB, valgrind, strace, Gecko/FireFox/XULRunner, nmap, OProfile, tcpdump, Pin, DynamoRIO, GnuTLS, OpenSSL, zeroconf, iptables, Git, svn (Subversion), Portsnap, ipfw, LARTC, socat, KVM/QEMU, Xen, VMWare ESXi, APT, vim\ldots\\
