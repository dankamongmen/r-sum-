...
\\
I seek expert-level UNIX systems programming or high-performance computing work.
\vspace{2mm}
...
\item\textbf{Languages (professional---minimum 2 active years):} C++, Python, Go, Erlang, XSLT/XPath
