...
{\indent}nmap, dpkg, strace, OpenSSL, APT-secure, Infinality, iproute2, bridge-utils, cpuid, Snort, and other projects.
...
\item \textbf{2012/01--2013/01, 2018/03--Present: Consulting Scientist, Dirty South Supercomputing (Atlanta, GA)\hfill \tiny{\textit{Founder}}}
\vspace{2mm}
\\
Bespoke consulting on low-level, embedded, and high-performance work including:
\begin{tightitemize}
...
\tiny
\begin{tightitemize}
\item\textbf{Operating Systems:} Linux (22 years), FreeBSD (6 years), Solaris (3 years), Windows NT (3 years)
...
Copyright \textcopyright\ 2019 Nick Black. All rights reserved. Distributed under the \href{http://creativecommons.org/licenses/by-sa/3.0/}{Creative Commons Attribution-ShareAlike 3.0} license.}
\end{document}
