...
\end{tightitemize}
  ...
  \item \textbf{2018/04--2024/03: Principal Software Engineer, Microsoft Azure Orbital}
\begin {tightitemize}
...
\item FCC-licensed radio operator (callsign KQ4ZNN).
\end{tightitemize}
...
algorithms and design for multicore/manycore machines. Electronics
and PCB design. POSIX APIs along with Linux and FreeBSD
...
Copyright \textcopyright\ 2024 Nick Black. All rights reserved. Distributed under the \href{http://creativecommons.org/licenses/by-sa/3.0/}{Creative Commons Attribution-ShareAlike 3.0} license.}
\end{document}
