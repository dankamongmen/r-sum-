...
{\noindent}I am actively seeking full-time work in high-performance/scientific computing, systems programming, compiler design, or security.
\vspace{2mm}
...
\item \textbf{2014/01--Present: Senior Software Engineer, Google (New York, NY)}
\begin{tightitemize}
...
\begin{tightitemize}
\item Led design work for the ArrayFire\texttrademark\ CUDA primitives library. Assisted ongoing design of the Jacket\texttrademark\ MATLAB\textsuperscript{\textregistered} plugin.
...
\tiny
\begin{tightitemize}
\item\textbf{Operating Systems:} Linux (16 years), FreeBSD (6 years), Solaris (3 years), Windows NT (3 years)
\item\textbf{Languages (expert---minimum 10 active years):} C, Bourne shell, x86 assembly, GNU Make
\item\textbf{Languages (professional---minimum 2 active years):} C++, Python, Erlang, Haskell, Prolog, Lisp, XSLT/XPath
\item\textbf{Languages (amateur---minimum 1 serious project):} Numerous assembly languages, Java, ML, Scheme, JavaScript (and XUL), Scala, Clojure
...
Copyright \textcopyright\ 2013 Nick Black. All rights reserved. Distributed under the \href{http://creativecommons.org/licenses/by-sa/3.0/}{Creative Commons Attribution-ShareAlike 3.0} license.}
\end{document}
